...
const TideChartCommentBox$json = const {
  ...
  '2': const [
    ...
    const {'1': 'alignment', '3': 12, '4': 1, '5': 17, '10': 'alignment'},
    const {'1': 'color', '3': 13, '4': 1, '5': 5, '10': 'color'},
    const {'1': 'background', '3': 14, '4': 1, '5': 5, '10': 'background'},
    const {'1': 'border', '3': 15, '4': 1, '5': 5, '10': 'border'},
    const {'1': 'raised', '3': 16, '4': 1, '5': 8, '10': 'raised'},
    const {'1': 'reversed', '3': 17, '4': 1, '5': 8, '10': 'reversed'},
  ],
  '8': const [
    const {'1': 'content'},
  ],
...
const TideChartWidget$json = const {
  ...
  '2': const [
    ...
    const {'1': 'posX', '3': 5, '4': 1, '5': 17, '10': 'posX'},
    const {'1': 'posY', '3': 6, '4': 1, '5': 17, '10': 'posY'},
    const {'1': 'width', '3': 7, '4': 1, '5': 5, '10': 'width'},
    const {'1': 'height', '3': 8, '4': 1, '5': 5, '10': 'height'},
    const {'1': 'link', '3': 9, '4': 1, '5': 9, '9': 0, '10': 'link'},
...
const TideChartPort$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ordinal', '3': 3, '4': 1, '5': 5, '10': 'ordinal'},
    const {'1': 'default', '3': 4, '4': 1, '5': 8, '10': 'default'},
    const {'1': 'required', '3': 5, '4': 1, '5': 8, '10': 'required'},
    const {'1': 'allowed', '3': 6, '4': 3, '5': 9, '10': 'allowed'},
    const {'1': 'hint', '3': 7, '4': 1, '5': 9, '10': 'hint'},
    const {'1': 'constant', '3': 8, '4': 1, '5': 11, '6': '.TideChartProperty', '10': 'constant'},
    const {'1': 'trigger', '3': 9, '4': 1, '5': 9, '10': 'trigger'},
    const {'1': 'filter', '3': 10, '4': 1, '5': 9, '10': 'filter'},
    const {'1': 'event', '3': 11, '4': 1, '5': 9, '10': 'event'},
    const {'1': 'sync', '3': 12, '4': 1, '5': 9, '10': 'sync'},
    const {'1': 'block', '3': 13, '4': 1, '5': 8, '10': 'block'},
    const {'1': 'queue', '3': 14, '4': 1, '5': 8, '10': 'queue'},
  ],
};
...
const TideChartLink$json = const {
  ...
  '2': const [
    ...
    const {'1': 'logging', '3': 16, '4': 1, '5': 8, '10': 'logging'},
    const {'1': 'debugging', '3': 17, '4': 1, '5': 8, '10': 'debugging'},
    const {'1': 'paused', '3': 18, '4': 1, '5': 8, '10': 'paused'},
    const {'1': 'disabled', '3': 19, '4': 1, '5': 8, '10': 'disabled'},
  ],
};
...
const TideChartGraph$json = const {
  ...
  '2': const [
    ...
    const {'1': 'nodes', '3': 7, '4': 3, '5': 11, '6': '.TideChartNode', '10': 'nodes'},
    const {'1': 'links', '3': 8, '4': 3, '5': 11, '6': '.TideChartLink', '10': 'links'},
    const {'1': 'regions', '3': 9, '4': 3, '5': 11, '6': '.TideChartRegion', '10': 'regions'},
    const {'1': 'comments', '3': 10, '4': 3, '5': 11, '6': '.TideChartCommentBox', '10': 'comments'},
    const {'1': 'widgets', '3': 11, '4': 3, '5': 11, '6': '.TideChartWidget', '10': 'widgets'},
    const {'1': 'props', '3': 12, '4': 3, '5': 11, '6': '.TideChartProperty', '10': 'props'},
    const {'1': 'history', '3': 13, '4': 3, '5': 11, '6': '.TideChartCommand', '10': 'history'},
    const {'1': 'logging', '3': 16, '4': 1, '5': 8, '10': 'logging'},
    const {'1': 'debugging', '3': 17, '4': 1, '5': 8, '10': 'debugging'},
    const {'1': 'paused', '3': 18, '4': 1, '5': 8, '10': 'paused'},
    const {'1': 'disabled', '3': 19, '4': 1, '5': 8, '10': 'disabled'},
